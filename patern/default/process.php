...
if (isset($_POST['generate']))
{
    ...
    if ($table_name <> '')
    {
        ...
        if (!file_exists($target . $c_url))
        {
            mkdir($target . $c_url, 0777, true);
        }
         
         if (!file_exists($target . $c_url . "/views/"))
        {
            mkdir($target . $c_url . "/views/", 0777, true);
        }
         
         if (!file_exists($target . $c_url . "/controllers/"))
        {
            mkdir($target . $c_url . "/controllers/", 0777, true);
        }
         
         if (!file_exists($target . $c_url . "/models/"))
        {
            mkdir($target . $c_url . "/models/", 0777, true);
        }
